export const newsTopics = [
    ...
    "Groundbreaking Helium-3 Mining Operation Begins on Moon",
    "First Successful Telepathic Communication Between Humans Achieved",
    "New Enzyme Discovered That Can Break Down Plastic in Record Time",
    "Global Moratorium on Deep-Sea Mining Announced",
    "AI-Powered Satellite Detects Previously Unknown Ancient Ruins",
    "Scientists Create First Self-Replicating Synthetic Life Form",
    "World's First Commercial Fusion Reactor Goes Online",
    "New Technology Allows Real-Time Translation of Animal Vocalizations",
    "Global Initiative Launches to Reverse Desertification",
    "Breakthrough in Quantum Entanglement Enables Instant Data Transfer",
    "AI System Develops New Form of Mathematics",
    "World's First Successful Head Transplant Performed on Human",
    "New Material Discovered That's Stronger Than Diamond",
    "Global Effort to Create Universal Vaccine for All Flu Strains Succeeds",
    "Scientist Develops Method to Extract Gold from E-Waste",
    "World's First City Powered Entirely by Wireless Electricity",
    "AI Creates Revolutionary New Programming Language",
    "Breakthrough in Photosynthesis Technology Doubles Crop Yields",
    "World's Largest Underground Park Opens in Abandoned Subway Station",
    "New Treatment Completely Eliminates Allergies in Clinical Trials",
    "Global Initiative Launches to Create Earth's Digital Backup on Moon"
];